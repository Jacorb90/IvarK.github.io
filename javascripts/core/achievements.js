const allAchievements = {
  ...
  ng5p11 : "Those ghosts are cold.", 
  ng5p12 : "Gigafield",
  ng5p13 : "Big Rip wasn't enough.",
  ng5p14 : "I can't see!",
  ng5p15 : "Truly Underchallenged", 
  ng5p16 : "Overchallenged",
  ng5p17 : "Strong Decay",
  ng5p18 : "Darkness encompasses us all.",
  ng5p21 : "Meta-Dimension Boost Boosts",
  ng5p22 : "So bright!",
  ng5p23 : "The Tree is dead", 
  ng5p24 : "Anti-Darkness",
  ng5p25 : "Spooky to the Max!",
  ng5p26 : "The Challenge is real.",
  ng5p27 : "The truth will be uncovered!",
  ng5p28 : "The Spirits haunt you forever.", 
  ng5p31 : "Why Dilate?",
  ng5p32 : "The fake Anti-Dilation modifier.",
  ng5p33 : "Underchallenged II", 
  ng5p34 : "The spookiest particle.",
  ng5p35 : "The spookiest of the spookiest.", 
  ng5p36 : "Betcha didn't know these existed!", 
  ng5p37 : "Replication Galore!",
  ng5p38 : "The pain haunts you forever.",
  ng5p41 : "Ghostify wasn't enough either.",
  ng5p42 : "Ghostly Quantum", 
  ng5p43 : "Time doesn't exist.",
  ng5p44 : "This Achievement doesn't exist 5",
  ng5p45 : "Exhaustion on the maximum level.", 
  ng5p46 : "Level Up!",
  ng5p47 : "So Close!",
...
function giveAchievement(name) {
	...
	if (allAchievementNums[name].split("ng5p")[1]&&!player.aarexModifications.ngp5V) return false
...
function updateAchievements() {
	...
	for (var i=1; i<29; i++) {
		...
		var rowid=i
		if (i>22) {
			shown=!(!player.aarexModifications.ngp5V)
			rowid="ng5p"+(i-22)
		} else if (i>15) {
		...
		if (shown) {
			...
			for (var l=0; l<8; l++) {
				...
				var achId="r"+achNum
				if (achNum>230) achId="ng5p"+(achNum-220)
				...
				if (achNum>230) {
					...
					document.getElementById(name).className = document.getElementById(name).className + " achievementTxt"
				}
			}
			if (n == 8) {
