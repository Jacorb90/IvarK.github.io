...
["You are now a pre-historic ghost!", "player.money.gte(Decimal.pow(10, 191140458264))", "am20"],
["You are devolving into Homo genuses!", "player.money.gte(Decimal.pow(10, 29821319640000))", "am21"],
["You should take a break.", "player.totalmoney.gt(Decimal.pow(10, 1e14))", "am22"],
["There is a lot of bugfixes coming, but I am too busy that I can't develop my modification a lot.", true, "am23"],
...
["Having fun waiting?", '(player.masterystudies !== undefined ? player.masterystudies.includes("d12") && player.quantum.nanofield.rewards < 16 : false)', "am96"],
...
["Why are we getting electrons when electrons are matter?", '(player.masterystudies !== undefined ? player.masterystudies.includes("d7") : false)', "am100"],
["Study 999 allows you to get meta antimatter galaxies.", 'player.masterystudies !== undefined', "am101"],
["Onionify coming December 32nd.", "player.newsArray.includes('am85')", "am102"],
["You shouldn't be able to see this one. If you are able to see this, then you should restart your game immediately because of reasons.", 'isNaN(player.money.e)', "am103"],
["I'm done writing news for today.", true, "am104"],
["Study 999 will never exist", 'player.masterystudies !== undefined', "am105"],
["AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAarex is a nice person", '(player.tickspeedBoosts !== undefined || player.masterystudies !== undefined)', "am106"],
["You can't get any faster.", 'bestECTime < 300', "am107"],
["Some Scientists discovered anti-null matter, which is very useful. These scientists are now the heads of all existing research programs.", 'player.newsArray.includes("a75")', "am108"],
...
["Waiting I see", '(player.masterystudies !== undefined ? player.quantum.nanofield.rewards > 14 : false)', "am118"],
